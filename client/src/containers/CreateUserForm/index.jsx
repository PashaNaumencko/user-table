...
import { Segment, Button, Header, Icon, Divider, Form as UIForm, Dropdown, Input } from 'semantic-ui-react';
...
class CreateUserForm extends React.Component {
  constructor(props) {
    ...
    this.state = {
      selectedGender: null,
      selectedTelCode: null
    };
  }

  renderField = ({ field, meta, placeholder }) => {
  ...
  render() {
    ...
    const { createUserLoading } = this.props;
